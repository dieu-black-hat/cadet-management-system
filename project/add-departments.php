...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $permissionName = $_POST['permname'];
    $firstName = $_POST['firstname'];
    $secondName = $_POST['secname'];
    $userId = $_POST['userid'];

    // Prepare the SQL statement
    $sql = "INSERT INTO permissions (role_name, permission_name, fname, lname, userid) VALUES (?, ?, ?, ?, ?)";
    
    // Prepare and bind the parameters
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssssi", $roleName, $permissionName, $firstName, $secondName, $userId);

    // Execute the statement
    if ($stmt->execute()) {
        // Data inserted successfully
        echo "Permission granted and data inserted into the database.";
    } else {
        ...
        <div class="col-xl-12 col-xxl-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Give Permission Form</h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label class="form-label">Role/Department Name</label>
