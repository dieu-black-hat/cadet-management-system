...
<body>
    ...
    ***********************************-->
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Unblock User Account</h4>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Unblock</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Unblock Accounts</a></li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="col-xl-12 col-xxl-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Unblock Accounts  Form</h5>
                </div>
                <div class="card-body">
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        // Prepare the SQL statement to update the status column
        $sql = "UPDATE users SET status = 'unblock' WHERE email = '$email'";
