                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Assign Company to a Company Commander</h4>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Assign Company</a></li>
                        </ol>
                    </div>
                </div>
                <?php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $platoonOneName = $_POST['Platoon_one_name'];
    $platoonTwoName = $_POST['Platoon_two_name'];
    $platoonThreeName = $_POST['Platoon_three_name'];
    ...
    SELECT ?, cadetid
    FROM cadet
    WHERE (platoon = ? OR platoon = ? OR platoon = ?)
      AND company = ?");

// Bind the parameters
$stmt->bind_param("issss", $userId, $platoonOneName, $platoonTwoName, $platoonThreeName, $companyName);
    // Bind the parameters
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                            <label class="form-label">Platoon one name</label>
                            <input type="text" class="form-control" name="Platoon_one_name" id="Platoon_one_name">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                            <label class="form-label">Platoon two name</label>
                            <input type="text" class="form-control" name="Platoon_two_name" id="Platoon_two_name">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                            <label class="form-label">Platoon three name</label>
                            <input type="text" class="form-control" name="Platoon_three_name" id="Platoon_three_name">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
