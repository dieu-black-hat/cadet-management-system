    ...
    ***********************************-->
    ...
    <div class="dropdown-menu dropdown-menu-right">
        ...
        <a href="index.html" class="dropdown-item ai-icon">
            <svg id="icon-logout" name="logout" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-out"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="edit-professor.html">Admins</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Admins</a></li>
                        </ol>
                    </div>
                </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <option>Select level or Department</option>
