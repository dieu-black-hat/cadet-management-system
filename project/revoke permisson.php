                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Give Permissions</a></li>
                        </ol>
                    </div>
                </div>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $permissionName = $_POST['perminame'];
    $roleName = $_POST['roname'];
    $userId = $_POST['user_id'];

    // Prepare the SQL statement
    $sql = "DELETE FROM permissions WHERE permission_name = ? AND role_name = ? AND userid = ?";
    
    // Prepare and bind the parameters
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sss", $permissionName, $roleName, $userId);
    ...
    if ($stmt->execute()) {
        ...
        // Error occurred while revoking permission
...
?>
    ...
    <div class="row">
        <div class="col-xl-12 col-xxl-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Revoke Permission Form</h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="perminame" id="perminame" class="form-control">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label class="form-label">Role Name</label>
                                    <input type="text" name="roname" id="roname" class="form-control">
                                </div>
                                <div class="form-group">
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &IT; Developed by <a href="../index.htm" target="_blank">Full-Stack Theblackhat</a> 2023</p>
            </div>
        </div>
        <!--**********************************
            Footer end
