...
<body>
    ...
    ***********************************-->
                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Block Accounts</a></li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="col-xl-12 col-xxl-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Block Accounts  Form</h5>
                </div>
                <div class="card-body">
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        $sql = "UPDATE users SET status = 'block' WHERE email = '$email'";
