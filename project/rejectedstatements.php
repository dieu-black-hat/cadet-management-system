...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO rejected_statements (cadetid, statementdescription, statementfile) VALUES ('$cadetid', '$statementDescription', '$statementFile')";
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        if ($conn->query($deleteSql) === TRUE) {
            echo "Rejected statement deleted from the 'statements' table.";
        } else {
            echo "Error deleting the Rejected statement from the 'statements' table: " . $conn->error;
        }
    } else {
        echo "Error storing the Rejected statement: " . $conn->error;
    }
...
elseif ($role_name === 'admin') {
    $sql = "SELECT cadetid, statementdescription, statementfile FROM rejected_statements";
}
            ...
            <div class="card" style="width: 315px; height: 350px;">
                ...
                <div class="card-body">
                    ...
                    <form action="" method="">
                        ...
                        <button type="submit"  class="btn btn-danger btn-block">Rejected <span class="btn-icon-right"><i class="fa fa-close"></i></span></button>  </form>
