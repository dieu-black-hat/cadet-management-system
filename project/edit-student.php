                ...
                <ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="aboutstudent.php">About Cadets</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
				...
				<div class="row">
					<div class="col-xl-12 col-xxl-12 col-sm-12">
                        <div class="card">
							...
							<div class="card-body">
                            <form action="cadeteditnow.php" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input name="joindate" class="datepicker-default form-control" id="joindate">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="platoon" id="platoon">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="parentsname" id="parentsname" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="form-label">Parents Mobile Number</label>
                                                <input type="text" name="parentsno" id="parentsno" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="form-label">Date of Birth</label>
                                                <input name="dateofbirth" class="datepicker-default form-control" id="dateofbirth">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="form-label">Blood Group</label>
                                                <input type="text" name="bloodgrp" id="bloodgrp" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <label class="form-label" name="address" id="address">Address</label>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <button type="submit1" class="btn btn-light">Cancel</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
